...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="tb-category" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Master Category</h5>
    ...
    @push('myscript')
        <script src="{{ asset('assets/js/apps/category/app.js') }}?{{ rand() }}"></script>
    @endpush
@endsection
